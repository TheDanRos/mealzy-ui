  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FDFBF9] px-4">
      <div className="max-w-md w-full text-center bg-white p-8 rounded-2xl shadow-lg">
        <CheckCircle className="mx-auto text-[#FF715B]" size={48} />
        <h1 className="text-2xl font-bold text-[#2B2B2B] mt-4 mb-2 font-dm-sans">
          Fast geschafft!
        </h1>
        <p className="text-base text-[#2B2B2B] font-inter mb-6">
        ...
        <p className="text-sm text-[#DADADA] mb-6">
          Nach der Bestätigung wirst du zur Onboarding-Seite weitergeleitet.
        </p>
        <Link href="/">
          <span className="inline-block px-4 py-2 bg-[#FF715B] text-white rounded-xl text-sm font-medium">
            Zur Startseite
          </span>
        </Link>
      </div>
